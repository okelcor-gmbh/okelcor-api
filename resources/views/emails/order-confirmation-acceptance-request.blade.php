...
<head>
    ...
    <title>Action required: Please confirm your Order — {{ $order->ref }}</title>
</head>
    ...
    <tr>
        <td style="padding:32px 36px 0 36px;">
            ...
            <p style="margin:0 0 28px 0;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#5c5e62;line-height:1.6;">
                Your Order Confirmation (<strong>{{ $document->number }}</strong>) for order
                <strong>{{ $order->ref }}</strong> is attached to this email.
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #eeeeee;margin-bottom:28px;">
                ...
                <tr>
                    ...
                    <td style="padding:12px 16px;font-family:Arial,Helvetica,sans-serif;font-size:13px;font-weight:700;color:#171a20;border-bottom:1px solid #eeeeee;">€{{ number_format($order->total, 2) }}</td>
                </tr>
                <tr>
                    <td style="padding:12px 16px;font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#5c5e62;background-color:#fafafa;">Link expires</td>
                    <td style="padding:12px 16px;font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#171a20;">{{ $expiresAt }}</td>
                </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                <tr>
                    <td align="center">
                        <a href="{{ $acceptUrl }}"
                           style="display:inline-block;padding:14px 36px;background-color:#f4511e;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:700;text-decoration:none;border-radius:3px;">
            ...
            <p style="margin:0 0 8px 0;font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#5c5e62;line-height:1.6;">
                Or copy this link into your browser:
            </p>
            <p style="margin:0 0 28px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#5c5e62;word-break:break-all;">
                <a href="{{ $acceptUrl }}" style="color:#f4511e;text-decoration:none;">{{ $acceptUrl }}</a>
            </p>
